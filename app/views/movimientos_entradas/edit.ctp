...
echo $this->Html->script(array('movimientos_entradas/movimientos_entradas_edit')); ?>
<script>
    $(document).ready(function () {
        $('#MovimientosEntradaTipoMovimientoId').trigger("change");
    });
...
<?php echo $this->Form->create('MovimientosEntrada');?>
    <fieldset>
        <legend><?php __('Editar Movimiento de Entrada'); ?> <span style="color: #0a0; font-weight: bold; ">#000<?php echo $id; ?></span></legend>
        <table class="table table-striped table-bordered table-condensed" align="center" style="width: 70%;">
            ...
            <tr>
                ...
                <td><?php echo $this->Form->input('fecha_movimiento', array('type' => 'text', 'label' => false, 'size' => '20', 'maxlength' => '10', 'readonly'=>true));?></td>
            </tr>
        </table>
