<?php
if (!empty($ordenes['0']['OrdenCompra']['id'])) {
    $pdf = '../ver_orden_pdf/' . $ordenes['0']['OrdenCompra']['id'];
} 
?>
<script type="text/javascript">
    window.open("<?php echo $pdf; ?>");
</script>
<h2>VER ORDEN DE COMPRA <span style="color: blue;"><b> #000<?php echo $ordenes['0']['OrdenCompra']['id']; ?></b></span></h2>
<table class="table table-striped table-bordered table-condensed" align="center" style="width: 70%;">
    ...
    <tr>
        <td><b>Elaboró:</b></td>
        <td><?php echo $ordenes['0']['User']['nombres_persona']; ?></td>
        <td><b>Aprobó:</b></td>
        <td><?php echo $ordenes['0']['User2']['nombres_persona']; ?></td>
    </tr>
</table>
...
<div class="text-center"><?php echo $this->Form->button('Regresar', array('type' => 'button', 'class' => 'btn btn-warning','onclick'=>'history.back();')); ?></div>