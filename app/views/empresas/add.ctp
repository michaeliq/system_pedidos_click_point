...
<fieldset>
    <legend><?php __('Nueva Empresa'); ?></legend>
    <table class="table table-striped table-bordered table-condensed" align="center">
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $this->Form->input('parametro_tiempo_pedido', array('type' => 'text', 'label' => false, 'maxlength' => '2','placeholder'=>'Tiempo en D�as')); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" class="text-center" >
                ...
                <?php echo $this->Form->button('Guardar Empresa', array('type' => 'submit', 'class' => 'btn btn-success')); ?>
            </td>
        </tr>
        <?php
        echo $this->Form->input('estado_empresa', array('type' => 'hidden', 'value' => true));
        ?>
    </table>
</fieldset>
