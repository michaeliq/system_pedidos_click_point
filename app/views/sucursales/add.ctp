...
<fieldset>
    <legend><?php __('Nueva Sucursal para ' . strtoupper($empresa['0']['Empresa']['nombre_empresa'])); ?></legend>
    <table class="table table-striped table-bordered table-condensed" align="center">
        <tr>
            <td>Sucursal: *</td>
            <td><?php echo $this->Form->input('nombre_sucursal', array('type' => 'text', 'label' => false, 'size' => '50', 'maxlength' => '60')); ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php echo $this->Form->input('regional_id', array('type' => 'select', 'options' => $regionales, 'empty' => 'Seleccione una Opción', 'label' => false)); ?>
                <?php echo $this->Form->input('regional_sucursal', array('type' => 'hidden')); ?></td>                
        </tr>
        <tr>
            <td>OI: </td>
        ...
        <tr>
            ...
            <td><?php
            if(!empty($plantillas)){
            echo $this->Form->input('plantilla_id2', array('type' => 'select', 'multiple'=>'multiple','options' => $plantillas, 'label' => false));
            }else{ 
                echo "<b>Es necesario crear una plantilla</b> <a href='/pedidos/plantillas/add' target='_blank'>Agregar</a>";
            }
            ?></td>
            <td>Auxiliares: </td>
...
//                                endforeach;    
        ...
        <tr>
            <td colspan="4" class="text-center" >
                ...
                <?php echo $this->Form->button('Guardar Sucursal', array('type' => 'submit', 'class' => 'btn btn-success')); ?>
            </td>
        </tr>
        <?php
        echo $this->Form->input('id_empresa', array('type' => 'hidden', 'value' => $id_empresa));
        echo $this->Form->input('estado_sucursal', array('type' => 'hidden', 'value' => true));
        ?>
    </table>
</fieldset>
