...
// Crear archivo plano csv
    $file_name = 'informes/InformeCantidadProductosPedidos.csv';
...
<h2><span class="glyphicon glyphicon-book"></span> INFORME CANTIDAD DE PRODUCTOS FECHAS</h2>
<?php echo $this->Form->create('PedidosDetalle', array('url' => array('controller' => 'informes', 'action' => 'info_cantidad_productos'))); ?>
<fieldset>
...
<table class="table table-hover">
    ...
    $data_csv = utf8_decode("CodigoProducto;NombreProducto;Cantidad\n");
    fwrite($file, $data_csv);
    foreach ($detalles as $detalle) :
    ?>
    <tr>
        <td><?php echo $detalle['VCantidadProducto']['codigo_producto']; ?></td>
        <td><?php echo $detalle['VCantidadProducto']['nombre_producto']; ?></td>
        <td><?php echo $detalle['0']['cantidad']; ?></td>
    </tr> 
        <?php
            $data_csv = utf8_decode($detalle['VCantidadProducto']['codigo_producto']) . ';' .
                utf8_decode($detalle['VCantidadProducto']['nombre_producto']). ';' .
