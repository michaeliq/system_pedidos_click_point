...
// Crear archivo plano csv
    $file_name = 'informes/InformePedidosAprobados.csv';
...
<script>
    ...
    $(function () {
        $('#PedidosDetalleFechaAprobadoPedido').datepicker({
            changeMonth: true,
            changeYear: true,
            showWeek: true,
            firstDay: 1,
...
<h2><span class="glyphicon glyphicon-book"></span> INFORME PEDIDOS APROBADOS</h2>
<?php echo $this->Form->create('PedidosDetalle', array('url' => array('controller' => 'informes', 'action' => 'info_pedidos_aprobados'))); ?>
<fieldset>
...
?>
    <tr>
        <td>#000<?php echo $pedido['PedidosDetalle']['pedido_id']; ?></td>
        <td><div  title="Ver"><?php echo $this->Html->link(__('', true), array('controller'=>'pedidos','action' => 'ver_pedido', $pedido['PedidosDetalle']['pedido_id']), array('class' => 'glyphicon glyphicon-search', 'escape' => false,'target'=>'_blank')); ?></div></td>
    </tr>
        <?php 
endforeach;
?>
...
<!--        <th>Precio Bruto Unitario</th>-->
    ...
    $data_csv = utf8_decode("Empresa;No. Orden;Estado;Regional;Centro de Costo;Centro de Costo OPESE;Orden Interna OPESE;Categoria;Descripcion;Fecha Pedido;Fecha Aprobado;Cantidad;Unidad;Precio Bruto Unitario;IVA;Precio Unitario Con Iva;Precio Total\n");
