...
<?php echo $this->Form->create('CronogramasInventario');?>
    <fieldset>
        <legend><?php __('Nuevo Cronogramas de Inventarios'); ?></legend>
        <table class="table table-striped table-bordered table-condensed" align="center">
            ...
            <tr>
                <td>Categorias: *</td>
                <td><?php echo $form->input('tipo_categoria_id', array('multiple' => 'checkbox', 'label' => false, 'options' => $tipoCategorias/*, 'selected' => $selected*/)); ?> 
	...
	<?php
		...
		echo $this->Form->input('fecha_registro', array('type' => 'hidden'));
	?>
    </fieldset>
