...
<!--        <tr>
        ...
        <tr>
            <th><input type="text" id="codigo_producto_sh" onkeyup="search_codigo_producto()" size="10" maxlength="12" placeholder="Código ..." title="Digite un código de producto"></th>
            <th colspan="11"><input type="text" id="nombre_producto_sh" onkeyup="search_nombre_producto()" size="60" maxlength="100" placeholder="Producto ..." title="Digite un nombre de producto"></th>
        </tr>
        <?php
