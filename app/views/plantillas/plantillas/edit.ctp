...
<fieldset>
    ...
    <table id="productos_plantilla" class="table-striped table-bordered table-hover table-condensed"align="center">
        ...
        <tr>
            ...
            <th>Precio CISE</th>
            <th>Precio<br>CEN.ASEO</th> <!-- 31052018-->
            <th>IVA</th>
            <th>Medida</th>
        ...
        <tr class="class_<?php echo $producto['Producto']['tipo_categoria_id']; ?>">
            ...
            <td><?php echo $tipo_categoria_nombre; // $this->Form->input('tipo_categoria_id_'.$producto['Producto']['id'], array('type' => 'select', 'options' => $tipoCategoria, 'empty' => 'Seleccione una Opción', 'label' => false,'default'=>$tipo_categoria_id)); ?></td>
            ...
            <td  class="text-right">$ <?php echo number_format($producto['Producto']['precio_producto'],0,",","."); echo $this->Form->input('precio_producto_'.$producto['Producto']['id'], array('type' => 'hidden', 'value' => $precio_producto));  //31052018 ?></td>
