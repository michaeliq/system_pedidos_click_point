...
<fieldset>
    ...
    <table id="productos_plantilla" class="table-striped table-bordered table-hover table-condensed"align="center">
        ...
        <tr>
            ...
            <th colspan="10"><input type="text" id="nombre_producto_sh" onkeyup="search_nombre_producto()" size="60" maxlength="100" placeholder="Producto ..." title="Digite un nombre de producto"></th>
        </tr>
        <?php
