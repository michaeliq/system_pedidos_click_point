...
<fieldset>
    <legend><?php __('Copiar Producto'); ?></legend>
    <table class="table">
        <tr>
            <td>
                <?php echo $this->Form->create('Producto',array('type' => 'file', 'action' => 'copiar')); ?>
                <table class="table table-striped table-bordered table-condensed" align="center">
                    <tr>
                        <td>C&oacute;digo: *</td>
                        <td colspan="3"><?php echo $this->Form->input('codigo_producto', array('type' => 'text', 'label' => false, 'maxlength' => '20', 'placeholder'=>'Código Centro Aseo','value'=>'')); ?> <b>(Copia de <?php echo $this->data['Producto']['codigo_producto']; ?>)</b></td>
                    </tr>
                    <tr>
                        <td>Producto: *</td>
...
*/ ?>
                ...
                <?php echo $this->Form->button('Copiar Producto', array('type' => 'submit', 'class' => 'btn btn-success')); ?>
                        </td>
                    </tr>
                <?php
