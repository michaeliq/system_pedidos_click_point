...
<!--        <th>Categor&iacute;a</th>-->
        <th>Precio Centro Aseo N. Nacional</th>
        <th>Precio Centro Aseo Bog/Sab</th>
        <th>IVA</th>
        <th>Medida</th>
        <th>Cantidad</th>
        <th>Total</th>
<!--        <th title="Incluir todos">Incluir <input name="Todos" type="checkbox" value="1" class="check_todos"/></th>-->
    ...
    <tr class="class_<?php echo $producto['Producto']['tipo_categoria_id']; ?>">
        ...
        <td><div id="total_producto_<?php echo $producto['Producto']['id']?>">$ <?php echo $total_producto; ?></div></td>
        <?php             
    ...
    <tr>
        <td colspan="6">&nbsp;</td>
        <td colspan="3"><?php echo $this->Form->input('pedido_entrega_parcial', array('type' => 'checkbox', 'label' => '<span class="glyphicon glyphicon-save" title="Guardar Sin Terminar" style="color:#47a447;"></span> <b>Guardar Sin Terminar</b>', 'checked' => false)); ?></td>
    </tr>
    <tr>
