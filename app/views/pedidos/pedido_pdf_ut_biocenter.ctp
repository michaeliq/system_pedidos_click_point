...
// Print a text
$pdf->Image(K_PATH_IMAGES.'logo_ut_biocenter.jpg', 10, 11, 30, '', '', '', '', false, 300);
...
$html = '<table cellspacing="1" cellpadding="1">
    ...
    <tr>
        <td style="border-top: 1px solid #000000; border-right: 1px solid #000000; border-left: 1px solid #000000;"><b>DE:</b> UT BIOCENTER
        </td>
    ...
    <tr>
        <td style=" border-bottom: 1px solid #000000; border-left: 1px solid #000000;"><b>Este  pedido es despachado por UT BIOCENTER
